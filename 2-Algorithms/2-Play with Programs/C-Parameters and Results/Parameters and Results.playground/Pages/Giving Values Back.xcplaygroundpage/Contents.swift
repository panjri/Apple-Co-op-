 ...
 */
func favouriteThing (catagory: String, thing: String) -> String {
    let statement = ("My favourite \(catagory) is \(thing)")
    return statement
}


let animalSentence = favouriteThing(catagory: "animal" , thing: "dog")
let foodSentence = favouriteThing(catagory: "food" , thing: "sushi")
let musicSentence = favouriteThing(catagory: "artist", thing: "PND")

let intro = "My name is Panjri \(animalSentence) and \(foodSentence) and \(musicSentence)."
print(intro)
