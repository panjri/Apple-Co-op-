 ...
 */
func weeklyPay (hours: Int, daysWorked: Int) -> String {
    let wage = 14
    let pay = (wage * hours) * daysWorked
    return "Your weekly pay is \(pay)"
}

let salaryStandard = weeklyPay(hours: 10, daysWorked: 7)
print(salaryStandard)
/*:
