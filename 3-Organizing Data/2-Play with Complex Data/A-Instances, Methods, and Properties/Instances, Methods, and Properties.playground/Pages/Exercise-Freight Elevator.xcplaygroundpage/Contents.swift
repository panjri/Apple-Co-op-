 ...
 */
var addLoadToBasket = (num1 * 3) + (num2 * 2) + num3
ricketyRope.canHandleAdditionalLoad(addLoadToBasket)
strongRope.canHandleAdditionalLoad(addLoadToBasket)

var strongestRope = TreehousePulley(weightCapacity: 1000000)
strongestRope.canHandleAdditionalLoad(addLoadToBasket)
/*:
