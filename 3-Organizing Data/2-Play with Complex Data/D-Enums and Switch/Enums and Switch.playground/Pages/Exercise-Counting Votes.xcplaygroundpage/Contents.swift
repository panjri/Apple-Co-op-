...
var factoryVotes = 0
enum ClassTripVotes {
    case chocolateFactory, beach
}

var classTripVotes = ClassTripDestination.chocolateFactory



for _ in tripDestinationVotes{
    switch classTripVotes {
    case .beach:
        beachVotes += 1
...
var schoolMascotOption = SchoolMascotOption.salamander


for option in mascotVotes {
    switch schoolMascotOption{
    case .salamander:
        salamaderVote += 1
    case .marmot:
        marmotVote += 1
