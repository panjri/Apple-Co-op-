 ...
 //   let height: Int
  ...
  //  }
   ...
   // func isBiggerThan(_ rectangle: Rectangle) -> Bool {
      //  return rectangle.area > self.area
...
var index = 0
var isLongerThan = songs[0].duration

for x in 0 ... songs.count - 1 {

if songs[x].duration > isLongerThan {
    isLongerThan = songs[x].duration
    index = x
...
print("The longest song has a duration of \(isLongerThan) seconds and this is a song number \(index) in the array")
