...
let numberOfPotBeliiedPigs = 1

let numberOfFish = 1

let numberOfSnakes = 1

let totalNumberOfAnimals = numberOfDogs + numberOfCats + numberOfTurtles + numberOfHamsters + numberOfPotBeliiedPigs + numberOfSnakes + numberOfFish


let totalNumberOfMammals = numberOfDogs + numberOfCats + numberOfHamsters + numberOfPotBeliiedPigs
